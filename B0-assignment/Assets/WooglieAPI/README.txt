...
Features:
	...
	- Extra monetization methods available (call advertisement break from in-game or add Wooglie "More Games" button to the game)
...
How to use:
	...
	- You will be sent to the game EDIT screen:
		...
		4) Your game is now pending review. You will receive an email when your game is reviewed.
